...
//#[test]
pub fn insert_with_vacant_entry() {
...
//#[test]
pub fn get_vacant_entry_without_using() {
...
//#[test]
pub fn key_of_layout_optimizable() {
...
//#[test]
pub fn reserve_does_not_allocate_if_available() {
    let mut slab = Slab::with_capacity(10);
    let mut keys = vec![];
...
//#[test]
pub fn reserve_exact_does_not_allocate_if_available() {
    let mut slab = Slab::with_capacity(10);
    let mut keys = vec![];
...
pub fn reserve_does_panic_with_capacity_overflow() {
    let mut slab = Slab::with_capacity(10);
    slab.insert(true);
...
//#[test]
//#[should_panic(expected = "capacity overflow")]
pub fn reserve_exact_does_panic_with_capacity_overflow() {
    let mut slab = Slab::with_capacity(10);
    slab.insert(true);
...
//#[test]
pub fn from_iterator_new_in_order() {
...
//#[test]
pub fn from_iterator_unordered() {
...
//#[test]
pub fn shrink_to_fit_no_vacant() {
...
//#[test]
pub fn shrink_to_fit_doesnt_move() {
...
//#[test]
pub fn shrink_to_fit_doesnt_recreate_list_when_nothing_can_be_done() {
...
//#[test]
pub fn compact_no_moves_needed() {
    let mut slab = Slab::new();
    for i in 0..10 {
        slab.insert(i);
    }
...
//#[test]
pub fn compact_moves_successfully() {
    let mut slab = Slab::with_capacity(20);
    for i in 0..10 {
        slab.insert(i);
    }
...
//#[test]
pub fn compact_doesnt_move_if_closure_errors() {
    let mut slab = Slab::with_capacity(20);
    for i in 0..10 {
        slab.insert(i);
    }
...
//#[test]
pub fn compact_handles_closure_panic() {
    let mut slab = Slab::new();
    for i in 0..10 {
        slab.insert(i);
    }
...
//#[test]
pub fn partially_consumed_drain() {
    let mut slab = Slab::new();
